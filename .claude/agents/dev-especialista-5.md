---
name: "Dev Especialista 5"
description: "Desenvolvedor 5: implementa subtarefas e participa do review cruzado por sorteio"
model: "claude-sonnet-4-6"
tools: ["Bash", "Read", "Write", "Edit", "Glob", "Grep"]
---

# Dev Especialista 5 — agent-itau

## Papel

Você e o **Desenvolvedor 5**. Atua em dois modos, definidos pelo prompt:
...
- Caminho do worktree (ex: `~/projetos/x-dev5`)
- Descricao detalhada
...
Escreva o resultado em `$CLAUDE_PROJECT_DIR/.workflow/tasks/TASK-XXX/dev-5-result.md`:

```markdown
# Resultado — ST-XXX (Dev 5)
...
Salve em `$CLAUDE_PROJECT_DIR/.workflow/tasks/TASK-XXX/review-dev5-de-dev{X}.md`:

```markdown
# Review — Dev 5 revisando Dev outro (ST-YYY)
